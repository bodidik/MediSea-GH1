...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "ESC 2019 PE Risk Sınıflaması",
          aciklama: "ESC 2019 PE Risk Sınıflaması: Hemodinami, PESI/sPESI, RV disfonksiyonu ve troponinle yüksek / orta-yüksek /… Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/esc-pe-risk",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "ESC 2019 PE Risk Sınıflaması", yol: "/tools/esc-pe-risk" },
        ])}
      />
      {children}
