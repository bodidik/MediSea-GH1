...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "Sistatin C ile eGFR",
          aciklama: "Sistatin C ile eGFR: CKD-EPI 2012 sistatin ve 2021 kreatinin-sistatin denklemleri. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/egfr-sistatin",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "Sistatin C ile eGFR", yol: "/tools/egfr-sistatin" },
        ])}
      />
      {children}
