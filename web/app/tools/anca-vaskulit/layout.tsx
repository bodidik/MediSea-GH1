...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "ACR/EULAR 2022 ANCA Vaskülitleri",
          aciklama: "ACR/EULAR 2022 ANCA Vaskülitleri: GPA, MPA ve EGPA sınıflama kriterleri aynı bulgulardan. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/anca-vaskulit",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "ACR/EULAR 2022 ANCA Vaskülitleri", yol: "/tools/anca-vaskulit" },
        ])}
      />
      {children}
