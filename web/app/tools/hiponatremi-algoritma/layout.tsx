...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Hiponatremi Tanı Algoritması — Serum/idrar",
    description: "Hiponatremi Tanı Algoritması: Serum/idrar osmolalitesi, idrar Na ve hacim durumuyla basamaklı ayırıcı tanı. Ücretsiz klinik hesaplayıcı — MediSea.",
    url: "/tools/hiponatremi-algoritma",
  },
};
...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "Hiponatremi Tanı Algoritması",
          aciklama: "Hiponatremi Tanı Algoritması: Serum/idrar osmolalitesi, idrar Na ve hacim durumuyla basamaklı ayırıcı tanı. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/hiponatremi-algoritma",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "Hiponatremi Tanı Algoritması", yol: "/tools/hiponatremi-algoritma" },
        ])}
      />
      {children}
