...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "KDIGO KBH Sınıflaması",
          aciklama: "KDIGO KBH Sınıflaması: GFR × albüminüri risk ısı haritası — G/A evresi, izlem sıklığı, sevk. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/kdigo-kbh",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "KDIGO KBH Sınıflaması", yol: "/tools/kdigo-kbh" },
        ])}
      />
      {children}
