...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "Revize Cenevre Skoru",
          aciklama: "Revize Cenevre Skoru: Pulmoner emboli klinik olasılığı — nesnel 8 madde, 0–22. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/revize-cenevre",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "Revize Cenevre Skoru", yol: "/tools/revize-cenevre" },
        ])}
      />
      {children}
