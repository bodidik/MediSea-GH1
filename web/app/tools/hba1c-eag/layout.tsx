...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "HbA1c → Ortalama Glukoz",
          aciklama: "HbA1c → Ortalama Glukoz: Tahmini ortalama glukoz (ADA/NGSP). Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/hba1c-eag",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "HbA1c → Ortalama Glukoz", yol: "/tools/hba1c-eag" },
        ])}
      />
      {children}
