  ...
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "RAPID Skoru",
          aciklama: "RAPID Skoru: Plevral enfeksiyonda 3 aylık mortalite riski — 0–7. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/rapid-plevral",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "RAPID Skoru", yol: "/tools/rapid-plevral" },
        ])}
      />
      {children}
