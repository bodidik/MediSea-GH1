...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "Ottawa SAK Kuralı",
          aciklama: "Ottawa SAK Kuralı: Akut baş ağrısında subaraknoid kanama araştırma kararı — 6 ölçüt. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/ottawa-sak",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "Ottawa SAK Kuralı", yol: "/tools/ottawa-sak" },
        ])}
      />
      {children}
