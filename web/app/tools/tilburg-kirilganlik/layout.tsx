...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "Tilburg Kırılganlık Göstergesi (TFI)",
          aciklama: "Tilburg Kırılganlık Göstergesi (TFI): Fiziksel, psikolojik ve sosyal boyut — 15 madde (≥ 5). Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/tilburg-kirilganlik",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "Tilburg Kırılganlık Göstergesi (TFI)", yol: "/tools/tilburg-kirilganlik" },
        ])}
      />
      {children}
