...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "Sgarbossa Kriterleri",
          aciklama: "Sgarbossa Kriterleri: Sol dal bloğu ya da pace ritminde akut MI — özgün ve Smith-modifiye. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/sgarbossa",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "Sgarbossa Kriterleri", yol: "/tools/sgarbossa" },
        ])}
      />
      {children}
