...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "ABC/2 Hematom Hacmi",
          aciklama: "ABC/2 Hematom Hacmi: İntraserebral kanamada BT'den hacim — ağırlıklı kesit sayımıyla. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/abc2-hematom",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "ABC/2 Hematom Hacmi", yol: "/tools/abc2-hematom" },
        ])}
      />
      {children}
