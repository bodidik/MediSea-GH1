...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "eGFR (CKD-EPI 2021)",
          aciklama: "eGFR (CKD-EPI 2021): Race-free böbrek fonksiyon analizi. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/egfr",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "eGFR (CKD-EPI 2021)", yol: "/tools/egfr" },
        ])}
      />
      {children}
    </>
