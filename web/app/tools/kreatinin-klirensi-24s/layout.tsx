...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "24 Saatlik Kreatinin Klirensi — Ölçülmüş CrCl, 1,73 m²",
    description: "24 Saatlik Kreatinin Klirensi: Ölçülmüş CrCl, 1,73 m² normalizasyonu ve toplama yeterliliği. Ücretsiz klinik hesaplayıcı — MediSea.",
    url: "/tools/kreatinin-klirensi-24s",
  },
};
...
export default function AracDuzen({ children }: { children: ReactNode }) {
  return (
    <>
      <JsonLd
        veri={aracSemasi({
          ad: "24 Saatlik Kreatinin Klirensi",
          aciklama: "24 Saatlik Kreatinin Klirensi: Ölçülmüş CrCl, 1,73 m² normalizasyonu ve toplama yeterliliği. Ücretsiz klinik hesaplayıcı — MediSea.",
          yol: "/tools/kreatinin-klirensi-24s",
        })}
      />
      <JsonLd
        veri={kirintiSemasi([
          ...
          { ad: "24 Saatlik Kreatinin Klirensi", yol: "/tools/kreatinin-klirensi-24s" },
        ])}
      />
      {children}
